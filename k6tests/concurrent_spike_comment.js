...
export let options = {
    ...
    scenarios:{
        spike_comment_nothing:{ //simulate people visiting page
        ...
        spike_comment:{ //simulate people visiting page and making posts
            executor: 'ramping-vus',
            exec: 'comment',
            startTime:'70s',
            startVUs: 0,
        ...
        spike_comment_nothing2:{ //simulate people visiting page after all posts made
            executor: 'ramping-vus',
            exec: 'get_comment_page',
            startTime: '110s',
            startVUs: 0,
